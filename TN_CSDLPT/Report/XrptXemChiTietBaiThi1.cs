...
{
    public partial class XrptXemChiTietBaiThi1 : DevExpress.XtraReports.UI.XtraReport
    {
        public XrptXemChiTietBaiThi1()
        {
            InitializeComponent();
        }
        public XrptXemChiTietBaiThi1(string MaSV, string MonHoc, int lan)
        {
            InitializeComponent();
